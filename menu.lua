...
menu.win = {
    ...
    draw = function ()
        ...
        love.graphics.setColor(1, 1, 1)
        love.graphics.setFont(Fonts.robot)
        love.graphics.printf(menu.win.text, 0, Display.height/2 - Fonts.blox2:getHeight(), Display.width, 'center')
        love.graphics.reset()

        love.graphics.setFont(Fonts.badrobot)
        love.graphics.setColor(1, 100 / 255, 1)
        love.graphics.printf(menu.win.text2, 0, Display.height/2 + Fonts.blox2:getHeight(), Display.width, 'center')
        love.graphics.reset()
    end
}
